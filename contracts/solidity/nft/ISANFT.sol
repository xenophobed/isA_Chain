    ...
    ReentrancyGuard
{
     ...
     * @return publicPrice Public mint price
     * @return whitelistPriceValue Whitelist mint price
     * @return publicEnabled Public sale status
     * @return whitelistEnabled Whitelist sale status
     */
