    ...
    ReentrancyGuard
{
    ...
    function votingPeriod() public view override returns (uint256) {
        return 1 weeks; // Default voting period
    }
    ...
    function _quorumReached(uint256 proposalId) internal view override returns (bool) {
        ...
        if (emergencyProposals[proposalId]) {
            ...
            return proposalVote.forVotes + proposalVote.abstainVotes >= emergencyQuorumVotes;
        }
        
        return proposalVote.forVotes + proposalVote.abstainVotes >= proposalQuorum(proposalId, snapshot);
    }
